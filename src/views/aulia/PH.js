    ...
    <>
      <div className="flex flex-wrap pt-12">
        <div className="w-full xl:w-6/12 mb-12 xl:mb-0 px-4">
          <HistoryChart name="Pengomposan pH" source1="phSayur" source2="phBuah" data={data} />
        </div>
        <div className="w-full xl:w-3/12 px-4">
          {/* <CardBarChart /> */}
          <CardHistoryTable source="phSayur" title="pH Sayur" data={data} />
        </div>
        <div className="w-full xl:w-3/12 px-4">
          {/* <CardBarChart /> */}
          <CardHistoryTable source="phBuah" title="pH Buah" data={data} />
        </div>
      </div>
    </>
  );
